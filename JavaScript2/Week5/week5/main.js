// step 1:
//  1- creating a function with star, end value and without using a callbacks...
...
//solving the same problem using callbacks...
function myFunction2(start,end,give3,give5){
  let myArray = []
  for(let i=start;i<=end;i++){
